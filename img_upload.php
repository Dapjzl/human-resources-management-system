                                            ...
                                            if ($error22 === 0) {
                                                if ($size22 < 3000000) {
                                                    ...
                                                    if ($upload22) {
                                                        ...
                                                        if ($user) {
                                                            $reg = dbConnect()->prepare("INSERT INTO employee(firstname, lastname, gender, dob, email, phone, city, state, emp_id, desg, dept, qual, address, bank, acctno, acctname, salary_id, role, profile_code, qualupload, emp_img) VALUES(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
                                                            $reg->execute([$fname,$lname,$gender,$dob,$email,$phone,$city,$state,$empid,$desg,$dept,$qualselect,$address,$bank,$accno,$accname,$salary,$role,$profile,$newQual,$newName]);
                                                            if($reg){
