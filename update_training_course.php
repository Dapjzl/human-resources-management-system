            ...
            <div class="iq-card-header d-flex justify-content-between">
               <div class="iq-header-title">
                  ...
                  <div class="form-group">
                     ...
                     <input name="upcourse" type="text" value="<?php echo $course_name ?>" class="form-control" id="title">
                  </div>
                  <div class="form-group">
                     <label for="cost">Training Cost:</label>
                     <input name="upcost" type="text"  value="<?php echo $cost?>" class="form-control" id="title">
                  </div>
                  <div class="form-group">
