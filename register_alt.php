                                                ...
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                       ...
                                                       <select class="form-control" id="dept" name="dept" placeholder="Department Name.">
                                                           ...
                                                           <option value="Planning & Budget">Planning & Budget</option>
                                                       </select>
                                                    </div>
                                                </div>
                                                <div class="col-md-12">
                                                    ...
                                                    <div class="form-group">
                                                       <label for="role">Role: *</label>
                                                        <select class="form-control" id="role" name="role">
                                                           ...
                                                           <option value="Welfare">Sysadmin</option>
                                                           <option value="Welfare">Employee</option>
                                                           <option value="Welfare">Staff</option>
                                                           <option value="Welfare">Senior Manager</option>
                                                           <option value="Welfare">Programmer</option>
                                                           <option value="Welfare">Maintenance</option>
                                                        </select>
                                                    </div>
                                                </div>
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                       <label for="workhour">Qualification: *</label>
                                                        <select class="form-control" id="qual" name="qualselect">
                                                           ...
                                                           <option value="Welfare">Ssce</option>
                                                           <option value="Welfare">HnD</option>
                                                           <option value="Welfare">OnD</option>
                                                           <option value="Welfare">BsC</option>
                                                           <option value="Welfare">MsC</option>
                                                           <option value="Welfare">Phd</option>
                                                        </select>
                                                       <input style="margin-top: 10px;" type="file" class="form-control" id="qualupload" name="qualupload" />
                                                    </div>
                                                </div>
                                             </div>
                                          </div>
