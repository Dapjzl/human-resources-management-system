   ...
   if (isset($_POST['submit'])) {
      ...
      if (empty($deptname) || empty($hod)) {
         ...
         if ($check->rowcount()>0) {
            ...
            $insert = dbConnect()->prepare("INSERT INTO department(dept_name, hod, last_update, update_by) VALUES(?,?,?,?)");
            $insert->execute([$deptname,$hod,$last_update,$fullname]);
            if ($insert) {
                     ...
                     <div class="col-sm-12 col-lg-8">
                        <div class="iq-card">
                           ...
                           <div class="iq-card-body">
                              <p>Create a department and include the Head of the Department's name from the dropdown list below.</p>
                              <form method="POST">
                                 <div class="form-group">
                                    <label for="deptname">Department Name:</label>
                                    <input name="deptname" type="text" class="form-control" id="deptname" placeholder="Enter desired department name...">
                                 </div>
                                 <div class="form-group">
